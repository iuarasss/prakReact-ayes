...
function BorderRadius(){
    return (
        <>
        <button className="border-2 border-blue-0 text-orange-300 px-4 py-2 ml-4 rounded-l-2xl"> Klik Saya </button>
        <button className="border-2 border-blue-0 text-orange-300 px-4 py-2 ml-4 rounded-e-2xl"> Klik Saya </button>
        </>
    )
}
...
function BackgroundColors(){
    return(
        <div className="m-4 bg-blue-950 text-white p-4 rounded-lg shadow-lg">
...
function FlexboxGrid(){
    return (
        <nav className="flex justify-between bg-blue-950 p-4 text-white">
            <h1 className="text-lg text-orange-300 font-bold">MyWebsite</h1>
